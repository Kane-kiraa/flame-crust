...
CPUQuota=80%
MemoryMax=380M
ExecStart=$JAVA_PATH -XX:+UseSerialGC -XX:TieredStopAtLevel=1 -XX:CICompilerCount=1 -Xss256k -Xms48m -Xmx220m -XX:MaxMetaspaceSize=140m -jar $BACKEND_DIR/target/flame-crust-api-1.0.0.jar
Restart=always
RestartSec=10
