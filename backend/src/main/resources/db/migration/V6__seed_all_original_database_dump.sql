...
-- 2. Users (Admin)
INSERT INTO `users` (`id`, `role_id`, `name`, `email`, `password_hash`, `status`, `created_at`, `deleted_at`) VALUES 
...
ON DUPLICATE KEY UPDATE name=VALUES(name), role_id=VALUES(role_id), password_hash=VALUES(password_hash), status=VALUES(status);
...
(5, 'drink', 'Drinks', 5, 1),
(26, 'Drink', 'Drink', 5, 1)
ON DUPLICATE KEY UPDATE slug=VALUES(slug), name=VALUES(name), sort_order=VALUES(sort_order), active=VALUES(active);

-- 4. Coupons
INSERT INTO `coupons` (`id`, `code`, `discount_type`, `discount_value`, `min_order_amount`, `expires_at`, `active`) VALUES 
...
ON DUPLICATE KEY UPDATE discount_type=VALUES(discount_type), discount_value=VALUES(discount_value), min_order_amount=VALUES(min_order_amount), active=VALUES(active);

-- 5. Customers
INSERT INTO `customers` (`id`, `name`, `email`, `phone`, `created_at`, `updated_at`, `password_hash`, `status`, `deleted_at`) VALUES 
...
-- 6. Addresses
INSERT INTO `addresses` (`id`, `customer_id`, `label`, `address_line`, `city`, `postal_code`, `notes`, `is_default`, `created_at`) VALUES 
...
ON DUPLICATE KEY UPDATE label=VALUES(label), address_line=VALUES(address_line), city=VALUES(city), is_default=VALUES(is_default);

-- 7. All 54 Original Products
INSERT INTO `products` (`id`, `category`, `description`, `image`, `name`, `popular`, `price`, `rating`, `spicy`, `tags`, `vegetarian`, `sku`, `category_id`, `base_price`, `active`, `created_at`, `updated_at`) VALUES 
...
ON DUPLICATE KEY UPDATE name=VALUES(name), price=VALUES(price), base_price=VALUES(base_price), image=VALUES(image), category=VALUES(category), tags=VALUES(tags), popular=VALUES(popular), spicy=VALUES(spicy), vegetarian=VALUES(vegetarian), active=VALUES(active);
