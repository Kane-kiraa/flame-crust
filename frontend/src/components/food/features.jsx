  ...
  return /* @__PURE__ */ jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "hidden" }),
        /* @__PURE__ */ jsx("div", { className: "relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-[1fr_1.4fr] gap-12 lg:gap-16 items-start", children: [
          /* @__PURE__ */ jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("h2", { className: "mt-4 font-serif text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.05] text-foreground", children: [
                  "We sweat the",
                  /* @__PURE__ */ jsx("br", {}),
                ...
                /* @__PURE__ */ jsxs("div", { className: "mt-8 relative rounded-3xl overflow-hidden aspect-[4/3] shadow-warm-lg ring-1 ring-border/60", children: [
                  /* @__PURE__ */ jsx(
                    "img",
                    {
